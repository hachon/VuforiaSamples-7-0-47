...
//    private float kBuildingScale = 0.012f;
    private float kBuildingScale = 0.048f;
...
//            mTeapot = new Teapot();
            ...
            try {
                mModel = new Model();
                mModel.loadModel(mActivity.getResources().getAssets(),
                        "ImageTargets/model.txt");
...
//                    : textureIndex;
            int textureIndex = trackable.getName().equalsIgnoreCase("venus") ? 0
                    : 1;
...
//                        mTeapot.getNumObjectVertex());
                ...
                GLES20.glActiveTexture(GLES20.GL_TEXTURE0);
                GLES20.glBindTexture(GLES20.GL_TEXTURE_2D,
                        mTextures.get(mTextures.size() - 1).mTextureID[0]);
                GLES20.glUniformMatrix4fv(mvpMatrixHandle, 1, false,
                        modelViewProjection, 0);
                GLES20.glUniform1i(texSampler2DHandle, 0);
                GLES20.glDrawArrays(GLES20.GL_TRIANGLES, 0,
